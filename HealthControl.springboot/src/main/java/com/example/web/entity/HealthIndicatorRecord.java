...
public class HealthIndicatorRecord extends BaseEntity {
    ...
    @TableField(value="HealthIndicatorTypeId",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="HealthIndicatorId",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="IsAbnormity",updateStrategy = FieldStrategy.IGNORED)
