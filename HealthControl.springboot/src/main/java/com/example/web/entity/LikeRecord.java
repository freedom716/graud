...
public class LikeRecord extends BaseEntity {
    ...
    @TableField(value="LikeUserId",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="LikeType",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="RelativeId",updateStrategy = FieldStrategy.IGNORED)
