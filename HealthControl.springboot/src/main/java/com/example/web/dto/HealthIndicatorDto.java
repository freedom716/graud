...
public class HealthIndicatorDto extends BaseDto
{
    ...
    // 在 HealthIndicatorDto 类中添加以下字段和方法
private String healthIndicatorTypeName;
    public String getHealthIndicatorTypeName() {
        return healthIndicatorTypeName;
    }
    public  void setHealthIndicatorTypeName(String healthIndicatorTypeName) {
    this.healthIndicatorTypeName = healthIndicatorTypeName;
}
