    ...
    const select = async (e) => {
      ...
      if (tempFilePaths && tempFilePaths.length > 0) {
        for (let tempFilePath of tempFilePaths) {
          let {
            Data
          } = await utils_http.Upload(tempFilePath);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c0e2b150"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/components/upload-images/upload-images.js.map
