        ...
        <el-card class="box-card">
            ...
            <div class="margin-top-sm">
                <el-form :inline="true" :model="searchForm" size="default">
                    <el-form-item label="是否异常" prop="IsAbnormity">
                        <el-input v-model.trim="searchForm.IsAbnormity"  placeholder="请输入是否异常"  :clearable="true" ></el-input>
                    </el-form-item>
                    <el-form-item label="指标分类">
                        <SigleSelect url="/HealthIndicatorType/List" class="search-input" columnName="Name" :clearable="true" columnValue="Id"
                            v-model="searchForm.HealthIndicatorTypeId">
                        </SigleSelect>
                    </el-form-item>                
                    <el-form-item label="健康指标">
                        <SigleSelect url="/HealthIndicator/List" class="search-input" columnName="Name" :clearable="true" columnValue="Id"
                            v-model="searchForm.HealthIndicatorId">
                        </SigleSelect>
                    </el-form-item>                
...
<!-- 编辑对话框 -->
        <el-dialog :title="formData.Id ? '修改健康指标记录' : '添加健康指标记录'" v-model="editorShow" width="50%" :lock-scroll="true"
            min-height="500px">
            <el-form v-if="editorShow" ref="editModalForm" :rules="editModalFormRules" :model="formData" label-width="140px"
              ...
              <el-row :gutter="10" class="edit-from-body">
                    ...
                    <el-col :span="24">
                        <el-form-item label="指标分类" prop="HealthIndicatorTypeId">
                          <SigleSelect url="/HealthIndicatorType/List" columnName="Name" columnValue="Id"  v-model="formData.HealthIndicatorTypeId" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>

                    <el-col :span="24">
                        <el-form-item label="健康指标" prop="HealthIndicatorId">
                          <SigleSelect url="/HealthIndicator/List" columnName="Name" columnValue="Id"  v-model="formData.HealthIndicatorId" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="是否异常" prop="IsAbnormity">
                            <el-input type="text" v-model="formData.IsAbnormity"  placeholder="请输入是否异常"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
        ...
        <!-- 数据表格 -->
        <PaginationTable ref="PaginationTableId" url="/HealthIndicatorRecord/List" :column="columnList">
...
const columnList = ref([
  ...
  {
    key: "HealthIndicatorId",
    hidden: true, 
  },
  {
    key: "HealthIndicatorDto.Name",
    title: "指标名称",
    width: "160px",
...
const CreateOrEditForm = async () => {
    ...
    await editModalForm.value.validate(async valid => {
        if (valid) {
            const { Success } = await Post(`/HealthIndicatorRecord/CreateOrEdit`, formData);
...
const BatchDelete = async () => {
    ...
    if (ids.length > 0) {
        try {
            ...
            const { Success } = await Post(`/HealthIndicatorRecord/BatchDelete`, { Ids: ids });
            if (Success) {
                PaginationTableId.value.Reload(searchForm);
                ElMessage.success('删除成功');
            }
